...
/* 1. Traga todos funcionarios que trabalhem no dp. de filmes
...
/* OBS: Como estamos trabalhando com OR e a segunda condicao é opcional
colocamos na primeira condição quem tem mais chances de uma saida verdadeira, 
pois a segunda condição não será checada nesse caso. */

/* 2. Lista de funcionarios(As) + emails que trabalham no dp. de filmes ou
no dp.lar */
...
/* 3. Funcionarios do sexo Masculino ou funcionarios que trablham
no jardim */
